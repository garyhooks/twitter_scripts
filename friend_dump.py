...
# This stops the process after number of new friends have been made...
# BE CAREFUL!!!! Twitter blocks you if you follow too many at once, so space it out
NEW_FRIENDS_LIMIT = 100

# in 15 minutes the maximum that can be read is 300
MAX_READ = 100
...
def friend_dump(api, username, target_username, friend_dump_file):
    ...
    print("\n")
    print("Saving the names of users following: " + target_username)
    print("---------------------------------------------------------------------------\n")
    ...
    try:
        ...
        for friends in tweepy.Cursor(api.followers, screen_name=target_username).pages():
            ...
            for friend in friends:
                ...
                if (limiter == MAX_READ):
                    print("\nSleeping for 5 minutes to avoid a rate limit error\n")
...
def main():
    ...
    friend_dump_file = BASE_PATH + "/" + target_username + " - followers.txt"

    # Call Function
    friend_dump(api, username, target_username, friend_dump_file)
